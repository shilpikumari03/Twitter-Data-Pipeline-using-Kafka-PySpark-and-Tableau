...
if __name__ == "__main__":
    spark = SparkSession \
        ...
        .master("local[*]") \
        .config("spark.jars", "file:///C:/kafka/big_data_project/mysql-connector-java-8.0.28.jar") \
        .config("spark.executor.extraClassPath", "file:///C:/kafka/big_data_project/mysql-connector-java-8.0.28.jar") \
        .config("spark.executor.extraLibrary", "file:///C:/kafka/big_data_project/mysql-connector-java-8.0.28.jar") \
        .config("spark.driver.extraClassPath", "file:///C:/kafka/big_data_project/mysql-connector-java-8.0.28.jar") \
